      ...
      <div>
        <AuroraBackground>
          ...
          <div className="w-full max-w-md mx-auto mt-20 relative z-10">
            <input
              type="text"
              placeholder="Enter the Marriage No"
          ...
          <Link href={"/blockchain-certificate-verification/status"}>
            <button
              className=" mt-6 pd-5 px-40 py-2  border border-neutral-800 bg-black relative group/btn from-black dark:from-black dark:to-black to-neutral-600 block dark:bg-black w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
              type="submit"
            >
              Verify certificate
              <BottomGradient />
